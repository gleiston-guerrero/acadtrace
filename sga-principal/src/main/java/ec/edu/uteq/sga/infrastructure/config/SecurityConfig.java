...
import ec.edu.uteq.sga.infrastructure.security.JwtFilter;
import ec.edu.uteq.sga.infrastructure.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/representante/**").hasAuthority("ROLE_REPRESENTANTE")
