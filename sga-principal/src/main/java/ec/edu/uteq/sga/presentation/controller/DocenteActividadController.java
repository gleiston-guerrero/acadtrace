...
public class DocenteActividadController {
    ...
    @Autowired
    private ec.edu.uteq.sga.infrastructure.repository.PeriodoEvaluacionRepository periodoEvaluacionRepository;

    @GetMapping("/periodos")
    public ResponseEntity<?> listarPeriodos() {
        List<ec.edu.uteq.sga.domain.entity.PeriodoEvaluacion> periodos = periodoEvaluacionRepository.findAll();
