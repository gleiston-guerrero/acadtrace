    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/personas/**").hasAnyAuthority("ROLE_DIRECTOR", "ROLE_SECRETARIA")
                        .requestMatchers("/api/uploads/**").hasAnyAuthority("ROLE_DIRECTOR", "ROLE_SECRETARIA", "ROLE_DOCENTE")
