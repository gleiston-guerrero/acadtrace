export const modulos = [
  ...
  { id: "estudiantes", label: "Estudiantes", desc: "Importación masiva y acceso al Portal Secretaría", color: "bg-green-50", iconColor: "text-green-500", icon: (
  ...
  {
    id: "asistencias",
    label: "Consulta de Asistencias",
    desc: "Grilla diaria, justificaciones y % por materia",
    color: "bg-emerald-50",
    ...
    )},
  {
    ...
    desc: "Años lectivos, esquema de calificaciones, usuarios y datos institucionales",
    color: "bg-slate-100",
