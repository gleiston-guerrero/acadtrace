package ec.edu.uteq.sga.representante.ui.screens.dashboard
...
class DashboardViewModel(
    ...
    private val _uiState = MutableStateFlow(
        DashboardUiState(
            teacherUsername = sessionManager.getUsername() ?: "Representante",
            teacherName = sessionManager.getUsername() ?: "Representante"
        )
    )
