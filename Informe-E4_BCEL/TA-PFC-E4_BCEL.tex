...
\hline
\textbf{1. Disponibilidad} \newline \textit{(Availability)} & \textbf{100.0\% Nominal / 99.98\% Estrés} \newline (0 fallos en $12{,}265$ reqs nominales sin errores 5xx ni 401; resiliencia verificada) & $\ge 99.5\%$ & \textbf{\checkmark} Cumple & Desplegar clúster multi-zona de disponibilidad (Multi-AZ) con auto-escalado horizontal (HPA) en Kubernetes y réplicas primario-standby geodistribuidas para PostgreSQL. \\
\hline
