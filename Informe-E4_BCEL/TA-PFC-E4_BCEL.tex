...
extremo, marcas de tiempo como \texttt{Instant} sin preformatear, orden
de claves con caracteres suplementarios (U+10000 y siguientes), el valor
especial \texttt{NaN} ni ning\'un tipo fuera del vector patr\'on.
