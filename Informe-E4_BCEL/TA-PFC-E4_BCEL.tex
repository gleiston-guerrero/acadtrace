...
La Tabla~\ref{tab:iso-matriz-calidad} presenta la matriz de calidad actualizada. Cabe destacar que la caracter\'istica de disponibilidad en producci\'on no se encuentra acreditada en la muestra actual, y las ventanas de estr\'es operan bajo un perfil no validado:

\begin{table}[H]
\centering
\scriptsize
\renewcommand{\arraystretch}{1.3}
\caption{Matriz de Evaluaci\'on de Calidad ISO/IEC 25010:2023 con Mediciones Parciales y Planes de Mejora.}
\label{tab:iso-matriz-calidad}
\begin{tabularx}{\textwidth}{|p{2.3cm}|p{3.7cm}|c|p{2.8cm}|X|}
\hline
...
\hline
\textbf{3. Fiabilidad} \newline \textit{(Reliability)} & 0 fallos nominales; sin estrés oficial validado & $<1.0\%$ & Nominal observado; E5 estrés pendiente & Obtener una corrida de estrés autenticada con cero fallos para E5. \\
\hline
