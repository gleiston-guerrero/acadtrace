...
\addlinespace
\textbf{4. Mantenibilidad} \newline \textit{(Maintainability)} & \textbf{JaCoCo: 100\% Core / 0.51\% Global} \newline (Cobertura total en \texttt{AuditoriaService} y \texttt{LamportClock}; 0.51\% global de instrucciones en SGA Principal) & $\ge 70.0\%$ (Core) & \textbf{\checkmark} Cumple & Ampliar la cobertura de pruebas unitarias hacia controladores y adaptadores de infraestructura para elevar la métrica global del proyecto. \\
\addlinespace
