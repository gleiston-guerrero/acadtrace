...
\begin{enumerate}
  \item \textbf{Unitarias:} Evidencia hist\'orica conservada de pruebas de servicios con dobles de prueba (Mockito en Java, \texttt{pytest-mock} en Python): Cobertura JaCoCo del modulo sga-principal: 48.1\% de instrucciones sobre el BUNDLE completo (excluyendo codigo generado gRPC, DTOs, entidades JPA y configuracion Spring). Compuerta CI configurada al 40\% minimo con \texttt{<element>BUNDLE</element>}, deuda tecnica documentada para elevar el umbral al 70\% en iteraciones posteriores.
