...
\hline
\textbf{Issue} & \textbf{PR} & \textbf{Módulo / Requerimiento} & \textbf{Autor} & \textbf{Revisor Cruzado} & \textbf{Criterio de Aceptación y Observación Técnica} \\
\hline
\#38 & \#48 & Soporte: Observabilidad y Elección de Líder & Juliana Emanuel & Pedro Castro & Verificación de contenedor \texttt{etcd}, scraping de Prometheus cada 15\,s y tablero Grafana sin paneles rotos. Aprobado tras validar métricas de salud. \\
\hline
\#41 & \#51 & Calidad: Trazabilidad y Filtro de Correlación & Ernesto Luna & Juliana Emanuel & Certificación de inyección de \texttt{X-Trace-Id} mediante \texttt{TraceIdFilter} con SLF4J MDC y compuerta JaCoCo ($\ge 70\%$) en microservicio de Secretaría. \\
\hline
\#44 & \#54 & Móvil: Persistencia Offline-First en SQLite & Keyla Bedon & Pedro Castro & Validación del patrón Repository con Room SQLite, tareas periódicas \texttt{WorkManager} y pruebas unitarias JVM de sincronización ejecutadas en verde. \\
\hline
\#47 & \#55 & Seguridad: Auditoría Inmutable y Conmutador & Ernesto Luna & Keyla Bedon & Validación del disparador \texttt{tg\_auditoria\_append\_only} en PostgreSQL (rechazo de UPDATE/DELETE) y conmutación efectiva de mecanismos $M_0$--$M_3$ vía \texttt{AUDIT}. \\
\hline
