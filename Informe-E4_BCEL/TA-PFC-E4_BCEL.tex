...
La evidencia actual se limita a los dos CSV promovidos y sus salidas derivadas. El \texttt{console.log} y el \texttt{validation.json} de \path{microservicio-soporte/resultados_candidatos/} pertenecen a una ejecución anterior y no acreditan temporalmente esta corrida. El resultado nominal local no demuestra disponibilidad de producción.
