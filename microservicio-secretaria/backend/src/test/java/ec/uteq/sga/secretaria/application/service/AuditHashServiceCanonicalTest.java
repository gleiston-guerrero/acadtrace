...
class AuditHashServiceCanonicalTest {
    ...
    @Test
    void contratoCanonicoV1CoincideConPrincipalYDocente() {
        AuditHashService service =
        ...
        assertEquals(
                esperado,
                service.jsonCanonico(contenido)
        );
    ...
    @Test
    void materialSensibleQuedaFueraDelCanonico() {
        AuditHashService service =
                new AuditHashService();
