    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/importacion-excel/**").hasAnyAuthority("DIRECTOR", "SECRETARIA")
                        .requestMatchers("/api/representantes/**").hasAnyAuthority("DIRECTOR", "SECRETARIA")
                        .requestMatchers("/api/matriculas/**").hasAnyAuthority("DIRECTOR", "SECRETARIA", "DOCENTE")
                        ...
                        .requestMatchers("/api/docentes/**").hasAnyAuthority("DOCENTE")
